...
javaDashboard.controller('freeLayoutCtrl', function($rootScope, $scope, $http, ModalUtils, $timeout, $stateParams,
    ...
    let loopData = function (arr, file) {
        ...
        while (tmp = arr.pop()){
            ...
            obj.name = tmp;
            obj.path = '/' + file.cataName.split(tmp)[0];
            obj.folder = true;
            obj.children = [];
