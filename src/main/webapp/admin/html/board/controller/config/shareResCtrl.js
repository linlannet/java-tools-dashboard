...
javaDashboard.controller('shareResCtrl', function ($scope, $http, ModalUtils, $filter) {
    ...
    var getRoleList = function () {
        $http.get("dash/adminrole/getRoleListAll.do").success(function (response) {
    ...
    var getFolderList = function () {
        return $http.post('dash/folder/familyTree.do', {folderIds: angular.toJson($scope.folderIds)}).success(function (response) {
    ...
    var getBoardList = function () {
        return $http.get("dash/adminuser/getBoardListUser.do").success(function (response) {
    ...
    var getDatasetList = function () {
        return $http.get("dash/dataset/list.do").success(function (response) {
    ...
    var getWidgetList = function () {
        return $http.get("dash/adminuser/getWidgetListUser.do").success(function (response) {
    ...
    $scope.grantRes = function () {
        ...
        $http.post("dash/adminrole/updateRoleResUser.do", {
