...
'user strict';
javaDashboard.controller('paramCtrl', function ($scope, $uibModal, $http) {
                    ...
                    _.each($scope.board.layout.rows, function (row) {
                        _.each(row.widgets, function (widget) {
                            if (widget.widget.id == c.widgetId) {
                                p = {
                                    datasourceId: widget.widget.content.datasource,
                                    query: angular.toJson(widget.widget.content.query),
                                    datasetId: null
                                };
                            }
                        });
