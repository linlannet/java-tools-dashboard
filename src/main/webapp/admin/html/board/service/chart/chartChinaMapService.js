/**
 * Created by Linlan on 2017/7/22.
 */
javaDashboard.service('chartChinaMapService', function () {
    this.render = function (containerDom, option, scope, persist,drill) {
        ...
        return new BoardHeatMapRender(containerDom, option).chart(height, persist);
    };
