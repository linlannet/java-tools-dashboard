/**
 * Created by Linlan on 2017/7/23.
 */
javaDashboard.service('chartChinaMapBmapService', function () {
    this.render = function (containerDom, option, scope, persist,drill) {
        ...
        return new BoardBMapRender(containerDom, option).chart(height, persist);
    };
