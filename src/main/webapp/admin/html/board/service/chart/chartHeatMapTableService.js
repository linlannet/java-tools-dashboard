/**
 * Created by Linlan on 2017/7/26.
 */
'use strict';
javaDashboard.service('chartHeatMapTableService', function () {
    ...
    this.render = function (containerDom, option, scope, persist) {
        ...
        return new BoardEChartRender(containerDom, option).chart(height, persist);
    };
        ...
        var option = {
            tooltip: {
                ...
                formatter: function (params) {
                    return 'x ' + boardTranslate("CONFIG.WIDGET.VALUE_AXIS") + ': ' + xAxisData[params.value[0]] +
                        '<br/>y ' + boardTranslate("CONFIG.WIDGET.VALUE_AXIS") + ': ' + yAxisData[params.value[1]] +
                        '<br/>' + boardTranslate("COMMON.VALUE") + ': ' + params.value[2];
                }
            },
            animation: false,
            toolbox: {
