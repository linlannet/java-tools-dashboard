 ...
 */
'use strict';
javaDashboard.service('chartHeatMapCalendarService', function () {
        ...
        var option = {
            tooltip: {
                ...
                formatter: function (params) {
                    return boardTranslate("COMMON.DATE") + ': ' + params.value[0] + "<br>"
                        + boardTranslate("COMMON.VALUE") + ": " + params.value[1];
                }
            },
            toolbox: {
                show: true,
