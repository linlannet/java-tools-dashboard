...
var BoardBMapRender = function (jqContainer, options, isDeepSpec) {
...
BoardBMapRender.prototype.theme = "theme-fin1"; // 主题

BoardBMapRender.prototype.chart = function (group, persist) {
    var self = this;
...
BoardBMapRender.prototype.changeSize = function (instance) {
