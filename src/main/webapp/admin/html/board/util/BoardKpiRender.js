var BoardKpiRender = function (jqContainer, options) {
    this.container = jqContainer; // jquery object
    this.options = options;
};

BoardKpiRender.prototype.html = function (persist) {
    var self = this;
...
BoardKpiRender.prototype.realTimeTicket = function () {
    var self = this;
    return function (o) {
...
BoardKpiRender.prototype.do = function () {
    var self = this;
    $(self.container).html(self.rendered());
};

BoardKpiRender.prototype.template =
