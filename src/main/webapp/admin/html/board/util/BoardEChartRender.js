...
var BoardEChartRender = function (jqContainer, options, isDeepSpec) {
...
BoardEChartRender.prototype.theme = "theme-fin1"; // 主题

BoardEChartRender.prototype.chart = function (group, persist) {
    var self = this;
...
BoardEChartRender.prototype.changeSize = function (instance) {
...
BoardEChartRender.prototype.addClick = function (chartConfig, relations, $state, $window) {
