package net.linlan.tools.data.aggregator.h2;
...
import net.linlan.datas.core.utils.DataProviderUtils;
import net.linlan.datas.core.utils.H2SyntaxHelper;
...
public class H2Aggregator extends InnerAggregator {
    ...
    public AggregateResult queryAggData(AggConfig config) throws Exception {
        ...
        try (Connection conn = jdbcDataSource.getConnection();
             Statement stat = conn.createStatement()) {
//            stat.execute("CREATE ALIAS IF NOT EXISTS f_todouble FOR \"net.linlan.datas.core.utils.ResultFunctions.parseStr2Double\" ");
//            stat.execute("DROP ALIAS IF EXISTS f_todouble;");//改f_todouble，需先DROP再CREATE一次可生效
            stat.execute("CREATE ALIAS IF NOT EXISTS f_todouble FOR \"net.linlan.tools.data.aggregator.utils.ResultFunctions.parseStrBigDecimal\" ");
