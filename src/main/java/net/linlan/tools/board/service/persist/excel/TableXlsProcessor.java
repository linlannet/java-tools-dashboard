...
/**
 * 
 * Filename:TableXlsProcessor.java
 * Desc:
 *
 * @author Linlan
 ...
 *
 */
public class TableXlsProcessor extends AbsXlsProcessor {
...
//                }
    ...
    private abstract class CellHelper {
        ...
        public CellHelper(XlsProcessor context, List<CellRangeAddress> mergeRegion, Cell cell) {
        ...
        protected abstract void parseMergeKey(XlsProcessor context, Cell cell);
    ...
    private class HCell extends CellHelper {
        ...
        public HCell(XlsProcessor context, List<CellRangeAddress> mergeRegion, Cell cell) {
            super(context, mergeRegion, cell);
        }

        @Override
        protected void parseMergeKey(XlsProcessor context, Cell cell) {
    ...
    private class VCell extends CellHelper {
        ...
        public VCell(XlsProcessor context, List<CellRangeAddress> mergeRegion, Cell cell) {
            super(context, mergeRegion, cell);
        }
