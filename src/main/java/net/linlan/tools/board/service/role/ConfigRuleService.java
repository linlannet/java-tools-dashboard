...
public class ConfigRuleService {
    ...
    @Around("execution(* net.linlan.tools.board.service.DashWidgetService.save(..)) || " +
            "execution(* net.linlan.tools.board.service.DashWidgetService.update(..)) || " +
            "execution(* net.linlan.tools.board.service.DashWidgetService.deleteById(..))")
    ...
    @Around("execution(* net.linlan.tools.board.service.DashDatasetService.save(..)) || " +
            "execution(* net.linlan.tools.board.service.DashDatasetService.update(..)) || " +
            "execution(* net.linlan.tools.board.service.DashDatasetService.deleteById(..))")
    ...
    @Around("execution(* net.linlan.tools.board.service.DashDatasourceService.save(..)) || " +
            "execution(* net.linlan.tools.board.service.DashDatasourceService.update(..)) || " +
            "execution(* net.linlan.tools.board.service.DashDatasourceService.deleteById(..))")
    ...
    @Around("execution(* net.linlan.tools.board.service.DashBoardService.save(..)) || " +
            "execution(* net.linlan.tools.board.service.DashBoardService.update(..)) || " +
            "execution(* net.linlan.tools.board.service.DashBoardService.deleteById(..))")
    ...
    @Around("execution(* net.linlan.tools.board.service.DashAdminUserService.addUser(..)) || " +
            "execution(* net.linlan.tools.board.service.DashAdminUserService.updateUser(..)))")
    ...
    @Around("execution(* net.linlan.tools.board.service.DashAdminRoleService.addRole(..)) || " +
            "execution(* net.linlan.tools.board.service.DashAdminRoleService.updateRole(..)) || " +
            "execution(* net.linlan.tools.board.service.DashAdminRoleService.updateRoleRes(..))")
    ...
    @Around("execution(* net.linlan.tools.board.service.DashAdminRoleService.updateRole(..))")
    ...
    @Around("execution(* net.linlan.tools.board.service.DashAdminUserService.updateUserRole(..)) ||" +
            "execution(* net.linlan.tools.board.service.DashAdminUserService.deleteUserRoles(..))")
    ...
    @Around("execution(* net.linlan.tools.board.service.DashAdminRoleService.updateRoleResUser(..))")
