...
import net.linlan.tools.board.service.DashWidgetService;
...
public class DashWidgetRoleService {
    ...
    @Around("execution(* net.linlan.tools.board.service.DashWidgetService.update(..))")
    ...
    @Around("execution(* net.linlan.tools.board.service.DashWidgetService.delete(..))")
