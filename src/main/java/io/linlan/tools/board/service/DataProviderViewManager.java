...
public class DataProviderViewManager {
    ...
    public static List<Map<String, Object>> getQueryParams(String type, String page) {
        ...
        try {
            ...
            for (Field field : fieldList) {
                ...
                DataQueryParameter DataQueryParameter = field.getAnnotation(io.linlan.commons.db.annotation.DataQueryParameter.class);
    ...
    public static List<Map<String, Object>> getDatasourceParams(String type) {
        ...
        try {
            ...
            for (Field field : fieldList) {
                field.setAccessible(true);
                DataSourceParameter DataSourceParameter = field.getAnnotation(io.linlan.commons.db.annotation.DataSourceParameter.class);
                Map<String, Object> param = new HashMap<>();
